...
class VolunteerApplicationForm(_BaseApplicationForm):
    ...
    class Meta(_BaseApplicationForm.Meta):
        ...
        widgets = {
            ...
            "friends": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "500"}),
            "studies_and_course": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "500"}),
            "weakness": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "500"}),
            "quality": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "500"}),
            "volunteer_motivation": forms.Textarea(attrs={"rows": 3, "cols": 40, "maxlength": "500"}),
            "graduation_year": forms.HiddenInput(),
            "phone_number": forms.HiddenInput(),
            "hear_about_us": CustomSelect(choices=models.HEARABOUTUS_ES),
            "other_hear_about_us": forms.TextInput(attrs={"autocomplete": "off", "maxlength": "500"}),
