...
class MentorApplicationForm(_BaseApplicationForm):
    ...
    class Meta(_BaseApplicationForm.Meta):
        ...
        widgets = {
            ...
            "fluent": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "150"}),
            "experience": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "300"}),
            "why_mentor": forms.Textarea(attrs={"rows": 2, "cols": 40, "maxlength": "500"}),
