...
ATTENDANCE = [(0, "Friday"), (1, "Saturday"), (2, "Sunday")]
...
KIND_STUDIES = [
    (ST_SECONDARY, "Secondary Education - Baccalaureate"),
    (ST_VOCATIONAL, "Vocational Training (FP)"),
    (ST_BACHELOR, "Bachelor’s Degree"),
    (ST_MASTER, "Master’s Degree"),
    (ST_OTHER, "Other"),
]

HACK_NAME = getattr(hackathon_variables, "HACKATHON_NAME", "HackAssistant")
EXTRA_NAME_VOLUNTEER = [" 2019 o anterior", " 2021", " 2022", " 2023", " 2024", " 2025"]
EXTRA_NAME_MENTOR = [" 2019 or before", " 2021", " 2022", " 2023", " 2024", " 2025"]

PREVIOUS_HACKS_VOLUNTEER = [
    (i, HACK_NAME + EXTRA_NAME_VOLUNTEER[i])
    for i in range(0, len(EXTRA_NAME_VOLUNTEER))
]

PREVIOUS_HACKS_MENTOR = [
    (i, HACK_NAME + EXTRA_NAME_MENTOR[i]) for i in range(0, len(EXTRA_NAME_MENTOR))
]

YEARS = [
    (int(size), size) for size in ("2025 2026 2027 2028 2029 2030 2031 2032".split(" "))
]
