...
class EventTicket:
    ...
    def update_class(self, issuer_id: str, class_suffix: str) -> str:
        ...
        **Warning:** This replaces all existing class attributes!
        ...
        response = self.http_client.put(
            url=f"{self.class_url}/{issuer_id}.{class_suffix}", json=updated_class
        )
    ...
    def add_class_message(
        ...
        response = self.http_client.post(
            ...
            json={"message": {"header": header, "body": body}},
        )
    ...
    # [START createObject]
    def create_object(
        self, issuer_id: str, class_suffix: str, object_suffix: str, object_pass: dict
    ) -> str:
        """Create an object.
    ...
    def update_object(self, issuer_id: str, object_suffix: str) -> str:
        ...
        **Warning:** This replaces all existing object attributes!
        ...
        response = self.http_client.put(
            url=f"{self.object_url}/{issuer_id}.{object_suffix}", json=updated_object
        )
    ...
    def patch_object(self, issuer_id: str, object_suffix: str) -> str:
        ...
        response = self.http_client.patch(
            url=f"{self.object_url}/{issuer_id}.{object_suffix}", json=patch_body
        )
    ...
    def add_object_message(
        self, issuer_id: str, object_suffix: str, header: str, body: str
    ) -> str:
    ...
    def batch_create_objects(self, issuer_id: str, class_suffix: str):
        ...
        for _ in range(3):
            ...
            batch_object = {
                ...
                "seatInfo": {
                    "seat": {"defaultValue": {"language": "en-US", "value": "42"}},
                    "row": {"defaultValue": {"language": "en-US", "value": "G3"}},
                    "section": {"defaultValue": {"language": "en-US", "value": "5"}},
                    "gate": {"defaultValue": {"language": "en-US", "value": "A"}},
                },
